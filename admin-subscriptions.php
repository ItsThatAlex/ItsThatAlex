...
<head>
	...
	<title><?php echo $website ?> | <?php echo $lang['subscriptions'] ?></title>
...
<?php include'include/header.php'; ?>
		<hr />
					...
					<li>
						...
						<li class="active">
									...
									<strong><?php echo $lang['subscriptions'] ?></strong>
							</li>
							</ol>
		...
		<table class="table table-bordered datatable" id="table-3">
			<thead>
				<tr class="replace-inputs">
					...
					<th><?php echo $lang['date_of_bought'] ?></th>
	...
	<?php 
		...
		<?php echo $lang['add_subscriptions'] ?>
		</div>	</a>
		...
		<div class="modal-dialog">
			...
			$packagess = mysqli_query($con, "SELECT * FROM `package`");
				...
				<div class="modal-footer">
					...
					<button type="button submit" class="btn btn-primary"><?php echo $lang['add_subscriptions'] ?></button>
					</form>
					</div>
				</div>
			</div>
