...
<head>
	...
	<title><?php echo $website ?> | <?php echo $lang['purchase'] ?></title>
...
<hr />
				...
				<h1><?php echo $lang['purchase_a_package'] ?></h1>
				<div class="main-row"> 
				<?php
...
$buy = " buy-three";
			...
			<div class="pricing-grid agileits-shadow" style="margin-bottom: 100px;">
				...
				<div class="price-bg">
					...
					<div class="buy'. $buy .'"> 
						<a href="#" onclick="myform'.$idpackage.'()" class="bg">'. $lang['buy_now'] .' </a>
					</div> </form>
				</div>
				</div>
