					...
					<div class="step" id="step-2">
						...
						<div class="form-group">
							<div class="input-group">
								...
								<input onkeypress="enableBtn()" type="password" class="form-control" name="confpassword" id="confpassword" placeholder="Confirm Password" autocomplete="off" />
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<button id="button1" type="submit" class="btn btn-success btn-block btn-login" >
								<i class="entypo-right-open-mini"></i>
