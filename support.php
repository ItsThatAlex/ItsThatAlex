...
<head>
 ...
 function MaxLengthTextarea(objettextarea,maxlength){
  if (objettextarea.value.length > maxlength) {
    ...
    alert('<?php echo $lang['limit_characters_detected']; ?> : '+maxlength+' characters max!');
   }
}
</script>
            ...
            <section id="content">
                <div class="container">
                    ...
                    <div class="col-md-6 well">
                        <legend><?php echo $lang['your_tickets'] ?></legend>
...
?>
 ...
 <div style="display:flex;">
            <div class="col-md-6 well">
                        <legend><?php echo $lang['submit_support_ticket'] ?></legend>
            <form method="POST"/>
            <label><?php echo $lang['subject'] ?>:</label></br>
            <div class="fg-line">
            <input type="text" name="subject" class="form-control input-sm" placeholder="<?php echo $lang['input_subject'] ?>" maxlength="20" onkeyup="javascript:MaxLengthTextarea(this, 20);" required>
            </div></br>
            <label><?php echo $lang['message'] ?>:</label></br>

            <textarea name="message" class="form-control" rows="8" placeholder="<?php echo $lang['input_message'] ?>" ></textarea></br>

            <button class="btn btn-blue btn-large btn-block "><?php echo $lang['submit_ticket'] ?></button>
            </form>
                    </div>
					</div>
                        </div>
