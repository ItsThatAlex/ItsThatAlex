...
$todaygenerations = $lang['unlimited'];
}else{
...
<head>
	...
	<title><?php echo $website ?> | <?php echo $lang['dashboard']; ?></title>
		...
		<hr />
			...
			<div class="col-sm-3 col-xs-6">
				...
				<div class="tile-stats tile-red">
					...
					<h3><?php echo $lang['registered_users']; ?></h3>
					<p><?php echo $lang['total_users_on_the_generator']; ?>.</p>
				</div>
			...
			<div class="col-sm-3 col-xs-6">
				...
				<div class="tile-stats tile-green">
					...
					<h3><?php echo $lang['account_types']; ?></h3>
					<p><?php echo $lang['total_account_types_we_have']; ?>.</p>
				</div>
			...
			<div class="col-sm-3 col-xs-6">
				...
				<div class="tile-stats tile-aqua">
					...
					<h3><?php echo $lang['total_generations']; ?></h3>
					<p><?php echo $lang['total_accounts_generated']; ?>.</p>
				</div>
			...
			<div class="col-sm-3 col-xs-6">
				...
				<div class="tile-stats tile-blue">
					...
					<h3><?php echo $lang['total_memberships']; ?></h3>
					<p><?php echo $lang['total_amount_of_paid_users']; ?></p>
				</div>
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<div class="panel-title">
							<h4>
								<?php echo $lang['real_time_server_stats']; ?>
								<br /></br>
								<small><?php echo $lang['the_current_server_uptime']; ?></small>
							</h4>
						</div>
   ...
   if($subscription == "1" && $_SESSION['rank'] !== '5'){
	...
	<div class="col-sm-6">
				...
				<div class="panel panel-invert" data-collapsed="0"><!-- setting the attribute data-collapsed="1" will collapse the panel -->
					...
					<!-- panel head -->
					<div class="panel-heading">
						<div class="panel-title">' .$lang['your_statistics']. '</div>
					...
					<div class="panel-body">
						...
						<center><p style="font-size:20px;"><i class="entypo-trophy"></i> '. $lang['your_subscription'] .' : ' . $packagename . '</p>
						<p style="font-size:20px;"><i class="entypo-cancel"></i>' .$lang['will_end']. ' : ' .$paidexpire. '</p>
						<p style="font-size:20px;"><i class="entypo-lock"></i> ' .$lang['generations']. ' : '.$generations.' /day</p>
						<p style="font-size:20px;"><i class="entypo-cw"></i> ' .$lang['remaining_generations']. ': '.$todaygenerations.'</p>
						<p style="font-size:20px;"><i class="entypo-arrows-ccw"></i> ' .$lang['total_generations']. ': '.$allgenerations.'</p></br>
						</center>
					</div>
					</div>						
					</div>
		...
		<div class="col-md-6">
				...
				<div class="panel panel-invert" data-collapsed="0"><!-- setting the attribute data-collapsed="1" will collapse the panel -->
					...
					<div class="panel-body">
						...
						<center><p style="font-size:20px;"><i class="entypo-trophy"></i> '. $lang['your_subscription'] .' : Admin </p>
						<p style="font-size:20px;"><i class="entypo-lock"></i> ' .$lang['generations']. ' : '. $lang['unlimited'] .'</p>
						<p style="font-size:20px;"><i class="entypo-cw"></i> '. $lang['remaining_generations'] .': '.$lang['unlimited'].'</p>
						<p style="font-size:20px;"><i class="entypo-arrows-ccw"></i> '. $lang['total_generations'] .': '.$allgenerations.'</p></br>
						</center>
					</div>
					</div>						
