...
<head>
	...
	<title><?php echo $website ?> | <?php echo $lang['users']; ?></title>
...
<?php include'include/header.php'; ?>
		<hr />
					...
					<li><a>
						...
						<li class="active">
									...
									<strong><?php echo $lang['users']; ?></strong>
							</li>
							</ol>
		...
		<br />
			...
			<div class="col-sm-3 col-xs-6">
				...
				<div class="tile-stats tile-primary">
					...
					<h3><?php echo $lang['yesterday_visit_record']; ?></h3>
		...
		<table class="table table-bordered table-striped datatable" id="table-2">
			<thead>
				<tr>
					<th>ID</th>
					<th><?php echo $lang['banned']; ?></th>
					<th><?php echo $lang['username']; ?></th>
					<th><?php echo $lang['email']; ?></th>
					<th><?php echo $lang['rank']; ?></th>
					<th><?php echo $lang['registered_date']; ?></th>
					<th><?php echo $lang['register_ip']; ?></th>
					<th><?php echo $lang['double_ip']; ?></th>
					<th><?php echo $lang['has_subscription']; ?></th>
			...
			<?php
					...
					if(mysqli_num_rows($usersquery) < 1){
							echo'
						<tr>
						<td><td><td><td><td><td><td><td>'. $lang['member_count'] .': 0</td></td></td></td></td></td></td></td></tr>
						';
					}else{
						...
						$banned = '<b><font color="red">' .$lang['yes']. '</font></b>';
						}
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-header">
					...
					<h4 class="modal-title">'. $lang['configure_user'] .' n°'. $row['id'] .'</h4>
				</div>
            ...
            <input type="text" name="edit-password" class="form-control" placeholder="' .$lang['leave_empty']. '" /></br>
			                <label>' .$lang['email']. ' :</label></br>
            <input type="text" name="edit-email" class="form-control"  value="'. $row['email'] .'" required/></br>
							<label>' .$lang['rank']. ' :</label></br>
...
<div class="modal fade" id="sample-modal-dialog-member">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					<h4 class="modal-title"><?php echo $lang['add_user']; ?></h4>
				</div>
            ...
            <input type="text" name="add-email" class="form-control"  placeholder="Ex: email@email.com" required/></br>
							<label><?php echo $lang['rank']; ?> :</label></br>
            <select name="add-rank" class="form-control" style="margin-bottom: 5px;" required>
					<option value="1"><?php echo $lang['member']; ?></option>
					<option value="5"><?php echo $lang['admin']; ?></option>
			</select>
				
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal"><?php echo $lang['cancel']; ?></button>
					<button type="button submit" class="btn btn-primary"><?php echo $lang['add_member']; ?></button>
					</form>
				</div>
			</div>
		</div>
