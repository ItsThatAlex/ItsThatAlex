...
<head>
	...
	<title><?php echo $website ?> | <?php echo $lang['support']; ?></title>
		...
		<hr />
					...
					<li><a href="admin-support">
						...
						<li class="active">
									...
									<strong><?php echo $lang['support']; ?></strong>
							</li>
							</ol>
...
echo'
           ...
           $icon = "bg-info";
			...
			<div class="col-md-12">
			<label>' .$lang['you']. ':</label></br>
			<textarea type="text" name="newreply" class="form-control" style="margin-bottom: 5px;" placeholder="' . $lang['reply_here'] . '." rows="10" required></textarea>
			
			<button type="submit" class="btn btn-success btn-large btn-block" style="margin-bottom: 5px;">' . $lang['add_reply'] . '</button></br>
		</form></div>
		';}elseif($isclose == "1"){
         echo'
         <center><h2>' . $lang['this_ticket_was_closed'] . ' </h2></center>
		 ';
            ...
            <section id="content">
                <div class="container">
                    ...
                    <div class="col-md-10 well" style="margin-left: 10px;">
                        <legend>' . $lang['all_tickets'] . '</legend>
...
echo '
						<tr>
							...
							<td>'.  $row['date']  .'</td>
							<td>'; if($row['isclose'] == "1"){
							echo'<span class="badge">' . $lang['closed'] . '</span>';}elseif($row['isclose'] == "0" && $row['isadminread'] == "0"){echo '
							<a href="admin-support?id='. $row['idticket'] .'" data-target="#message'.$row['id'].'" data-parent="#menu">
							<span class="badge badge-secondary">'. $lang['new_reply'] .'</span>
							</a>
							';}elseif($row['isclose'] == "0" && $row['isadminread'] == "1"){
							echo'
							<a href="admin-support?id='. $row['idticket'] .'" data-target="#message'.$row['id'].'" data-parent="#menu">
							<span class="badge badge-info">'. $lang['waiting_reply'] .'...</span>
							</a>
							';} echo'</td>
						</tr>
';}}
