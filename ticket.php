		...
		<hr />
					...
					<ol class="breadcrumb bc-3" >
						...
						<a href="index"><i class="fa-home"></i><?php echo $lang['home']; ?></a>
													...
													<li>
						<a href="support"><i class="fa-home"></i><?php echo $lang['support']; ?></a>
					</li>
						<li class="active">
									<strong><?php echo $lang['ticket']; ?></strong>
...
echo'
		...
		<form action="ticket?id=' . $getid . '" method="POST">
		<button name= "closeticket" type="submit" class="btn btn-red btn-large btn-block" onClick="say_hi()">' .$lang["close_ticket"]. '</button></br></div>
		</form>
		';}elseif($isclose == "1"){
         echo'
