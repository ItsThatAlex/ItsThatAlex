...
<head><meta http-equiv="Content-Type" content="text/html; charset=euc-kr">
	...
	<title><?php echo $website ?> | <?php echo $lang['private_generator']; ?></title>
		...
		<hr />
					...
					<ol class="breadcrumb bc-4" >
						...
						<li class="active">
									...
									<strong><?php echo $lang['private_generator']; ?></strong>
							</li>
							</ol><?php
					...
					while ($row = mysqli_fetch_array($result)) {
						...
						echo'
							...
							<center><div class="popover-secondary" data-toggle="popover" data-trigger="hover" data-placement="bottom" data-content="This is a Private Generator which means it will delete the account/key when it is generated, so only you have this alt/key." data-original-title="What is private generator?" style="
										  ...
										  "><font color="white">' . $lang['private_generator'] . '</font></div></center></a>
								...
								<a href="#">
							'. $name .'
							<span>'. $lang['generate_your_account'] .' </span>
						</a>
					</div>
					
					<div class="tile-content">
					<font color="white"><center><h2><i class="entypo-user"></i>:<i class="entypo-key"></i></h2></center></font>
					...
					<button type="button" id="generate'.$row["id"].'" class="btn btn-block">' .$lang['generate']. '</button>
                        <a onclick="myFunction'.$row["id"].'()" id="copy'.$row["id"].'" data-clipboard-target="generator'.$row["id"].'" title="Copy" class="btn btn-block">' .$lang['copy']. '</a>
                    </div>
                </div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-header">
					...
					<h4 class="modal-title">'. $lang['configure_color'] .' n°'.$id . '</h4>
				</div>
...
<option value="tile-block tile-blue"></option>
