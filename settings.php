...
<head>
	...
	<title><?php echo $website ?> | <?php echo $lang['settings']; ?></title>
...
<?php include 'include/header.php'; ?>
		...
		<hr />
		<h1 class="margin-bottom"><?php echo $lang['settings']; ?></h1>
		...
		<form method="post" class="form-horizontal form-groups-bordered validate" action="settings">
			...
			<p> <?php echo $lang['passwords_are_not_same']; ?> ! </p>
			</div>
			<div id="error-current" class="login-error" style="display:none;"></br>
			<h3> <?php echo $lang['error']; ?> </h3>
				<p> <?php echo $lang['your_current_password_is_not_this']; ?> ! </p>
			</div>
						...
						<div class="panel-body">
							<div class="form-group">
								<label for="field-1" class="col-sm-3 control-label"><?php echo $lang['username']; ?></label>
								
								<div class="col-sm-5">
									<input type="text" class="form-control" id="field-1" value="<?php echo $username?>" readonly>
									<span class="description"><?php echo $lang['you_can_not_modify_your_username']; ?>.</span>
								</div>
							</div>
			
							<div class="form-group">
								<label for="field-2" class="col-sm-3 control-label"><?php echo $lang['email']; ?></label>
								
								<div class="col-sm-5">
									<input type="text" class="form-control" id="field-2" value="<?php echo $email ?>" readonly>
									<span class="description"><?php echo $lang['you_can_not_modify_your_email']; ?>.</span>
								</div>
							</div>
				<hr />
							<div class="form-group">
								<label for="field-3" class="col-sm-3 control-label"><?php echo $lang['curr_pass']; ?></label>
							...
							<div class="form-group">
								<label for="field-4" class="col-sm-3 control-label"><?php echo $lang['new_pass']; ?></label>
							...
							<div class="form-group">
								<label for="field-4" class="col-sm-3 control-label"><?php echo $lang['conf_pass']; ?></label>
				...
				<button type="reset" class="btn"><?php echo $lang['reset_previous']; ?></button>
			                </div></center>
							</form>
				</div>
			</div>
		...
		jQuery( document ).ready( function( $ ) {
			...
			$( '#table-3 tfoot th' ).each( function () {
				...
				$(this).html( '<input type="text" class="form-control" placeholder="<?php echo $lang['search']; ?> ' + title + '" />' );
			} );
